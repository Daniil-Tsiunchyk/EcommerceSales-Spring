...
`Ecommerce Operations Monitor` разделено на две основные роли:

- **Пользователь**: Пользователи могут формировать заказы из товаров, доступных на складе. Они также могут просматривать свою историю заказов и их текущие статусы.

- **Администратор**: Администраторы имеют возможность изменять статусы заказов, просматривать аналитику, которая включает круговые диаграммы и графики продаж, а также топ-10 самых продаваемых товаров. Они могут формировать отчеты в формате PDF, управлять статусами заказов, добавлять новые товары и изменять их количество, добавлять категории товаров, изменять данные аккаунтов и назначать акции категориям. Администраторы также могут просматривать прошедшие акции.
